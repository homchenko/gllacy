      ...
      <div class="content-wrapper">
        ...
        <main class="main-content">
          ...
          <section class="filter">
            ...
            <form action="{{route('filter')}}" class="filter-form" method="post">
            {{csrf_field()}}
              <!--<div class="sort">
              ...
              <div class="price-range">
                <!--<p class="filter__title price-range__indicator">
                  Цена:
                  <span class="min-price">5</span> руб. &ndash; <span class="max-price">20</span> руб.
                </p>
              ...
              <div class="fat">
                ...
                <div class="field-container">
                  ...
                  <p class="fat__element">
                    <input type="radio" class="visually-hidden" name="fat" value="15" id="fat-15">
                    <label for="fat-15">до 15%</label>
                  </p>
                  <p class="fat__element">
                    <input type="radio" class="visually-hidden" name="fat" value="25" id="fat-25">
                    <label for="fat-25">до 25%</label>
                  </p>
                  <p class="fat__element">
                    <input type="radio" class="visually-hidden" name="fat" value="35" id="fat-35">
                    <label for="fat-35">до 35%</label>
                  </p>
                </div>
              </div>
              <div class="filters">
                ...
                <div class="field-container">
                  <p class="fillers__element">
                    <input type="checkbox" class="visually-hidden" name="filter[]" id="chocolate" value="chocolate">
                    <label for="chocolate">Шоколадные</label>
                  </p>
                  <p class="fillers__element">
                    <input type="checkbox" class="visually-hidden" name="filter[]" id="caramel" value="caramel">
                    <label for="caramel">Карамель</label>
                  </p>
                  <p class="fillers__element">
                    <input type="checkbox" class="visually-hidden" name="filter[]" id="fruits" value="fruits">
                    <label for="fruits">Фрукты</label>
                  </p>
                  <p class="fillers__element">
                    <input type="checkbox" class="visually-hidden" name="filter[]" id="syrup" value="syrup">
                    <label for="syrup">Сиропы</label>
                  </p>
                  <p class="fillers__element">
                    <input type="checkbox" class="visually-hidden" name="filter[]" id="jam" value="jam">
